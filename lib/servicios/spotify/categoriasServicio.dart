...
class CategoriasServicio {
  Client client = Client();
    String url = "https://api.spotify.com/v1/browse/categories?country=CO";
  Future<Categorias> fetchCategorias() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Categorias.fromJson(json.decode(response.body));
    } else {
