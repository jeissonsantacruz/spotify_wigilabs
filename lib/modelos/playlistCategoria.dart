...
//
//     final playlistModelo = playlistModeloFromJson(jsonString);

import 'dart:convert';

PlaylistModelo playlistModeloFromJson(String str) => PlaylistModelo.fromJson(json.decode(str));

String playlistModeloToJson(PlaylistModelo data) => json.encode(data.toJson());
...
class PlaylistModelo {
    ...
    factory PlaylistModelo.fromJson(Map<String, dynamic> json) => PlaylistModelo(
...
final uriValues = EnumValues({
    "spotify:user:spotify": Uri.SPOTIFY_USER_SPOTIFY
});
