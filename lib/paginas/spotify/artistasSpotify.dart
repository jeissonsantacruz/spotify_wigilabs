...
import 'package:firebaseauth/modelos/albunes.dart' as albun;
...
class _ArtistasScreemState extends State<ArtistasScreem> {
  ...
  Widget build(BuildContext context) {
    ...
    if (arguments != null) {
      ...
      artistasBloc.fectAlbune("https://api.spotify.com/v1/artists/${_artistas.id}/albums?include_groups=single%2Cappears_on&market=ES&limit=10&offset=5");
    }
